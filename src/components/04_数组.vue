...
console.log(arr3);
arr3.push(1)
console.log(arr3); // 自动更新类型 number[]
arr3.push('123')
console.log(arr3);// (string | number)[]
...
const arr6: readonly number[] = [1, 2]
...
console.log(arr8);
const arr9: Readonly<number[]> = [1, 2]
console.log(arr9);
const arr10 = [0, 1] as const
console.log(arr10);

// 5.多维数组
const multi: number[][] = [[1, 2, 3], [1, 2, 3]]
console.log(multi);
